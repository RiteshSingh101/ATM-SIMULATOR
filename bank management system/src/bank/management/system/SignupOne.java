...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){  
        ...
        JLabel mariral = new JLabel("Marital Status:");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                setVisible(false);// close next page
                new signupTwo(formno).setVisible(true);// open next page
                // take value of formno to database act as primary key 
            }
        } catch(Exception e){
